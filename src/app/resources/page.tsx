      ...
      <div className="space-y-6 pb-4 border-b border-gray-100">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs font-mono text-[#5A5A6E]">
            Displaying {filteredDocuments.length} of {allDocuments.length} Documents
          </div>
        </div>
              ...
              <div className="double-bezel-inner p-6 sm:p-7 flex flex-col justify-between h-full space-y-4">
                ...
                <div className="pt-3 border-t border-gray-100">
                  <a
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-medium text-xs bg-[#1E2A78] text-white hover:bg-[#1E2A78]/90 transition-colors shadow-2xs"
                  >
