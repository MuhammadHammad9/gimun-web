...
export default function ClarificationsPage() {
  const initialClarifications = getClarifications();
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-12">
      ...
      <header className="space-y-4 max-w-3xl">
        ...
        <p className="text-sm sm:text-base text-[#5A5A6E] leading-relaxed">
          Formal questions submitted by participating teams and binding interpretations issued by the Bench Drafting Committee. All rulings published here constitute official addenda to the 2027 Compromis.
        </p>
      </header>
            ...
            {formSubmitted ? (
              <div className="p-6 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900 space-y-2">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-emerald-800 underline hover:text-emerald-900 pt-2 block"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-xs focus:outline-hidden focus:ring-2 focus:ring-[#00B4A6]/20 focus:border-[#00B4A6]"
                    />
                  </div>
                ...
                <div className="pt-2">
                  <Button variant="track-moot" size="md" icon={<Send className="w-4 h-4" />}>
