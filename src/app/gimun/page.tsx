  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-20">
      ...
      <HeroSection
        variant="gimun"
        eyebrow={
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-mono font-semibold bg-[#FF6B35]/20 border border-[#FF6B35]/30 text-[#FFA27B] shadow-xs">
        ...
        title={
          <>
            ...
            <span className="text-gradient-orange">Defend Sovereignty</span>. Lead Nations.
          </>
        }
        ...
        sideContent={
          <div className="glass-card-dark rounded-2xl p-6 sm:p-8 space-y-4 border border-[#FF6B35]/30">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono uppercase tracking-wider text-[#FFA27B] font-bold">
                At a Glance
              </span>
            ...
            <div className="pt-2 border-t border-white/10">
              <Link
                href="/gimun/rules"
                className="text-xs font-semibold text-[#FFA27B] hover:text-white inline-flex items-center gap-1.5 transition-colors"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-white border border-gray-200/80 shadow-xs space-y-3 relative overflow-hidden group hover:border-[#FF6B35]/40 transition-colors">
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-xl bg-[#FF6B35]/10 flex items-center justify-center text-[#FF6B35] shadow-xs">
                  <Globe2 className="w-5 h-5" />
                </div>
                <span className="text-xs font-mono font-bold text-[#FF6B35]">01</span>
              </div>
              <h3 className="font-heading font-bold text-lg text-[#1A1A2E]">
                Country Portfolio
              </h3>
              <p className="text-xs text-[#5A5A6E] leading-relaxed">
                You are assigned a sovereign state portfolio within your committee. Your task is to champion that nation&apos;s foreign policy and national security priorities.
              </p>
            </div>
        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="double-bezel">
              <div className="double-bezel-inner p-8 space-y-4 border-l-4 border-l-[#FF6B35]">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono uppercase tracking-wider text-[#FF6B35] font-bold">
                    Participation Path A
                  </span>
                  <span className="text-xs font-mono px-2.5 py-0.5 rounded-full bg-orange-100 text-orange-800 font-semibold">
                    Individual
                  </span>
                </div>
            ...
            <div className="double-bezel">
              <div className="double-bezel-inner p-8 space-y-4 border-l-4 border-l-[#1E2A78]">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono uppercase tracking-wider text-[#1E2A78] font-bold">
                    Participation Path B
                  </span>
                  <span className="text-xs font-mono px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-800 font-semibold">
                    Group Delegation
                  </span>
                </div>
                <h3 className="font-heading font-bold text-2xl text-[#1A1A2E]">
